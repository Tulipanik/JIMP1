...
main(int argc, char *argv[])
{
	...
	printf("Norma pierwsza wczytanego wektora = %f\n", norma_pierwsza(w_1, n1));
	printf("Normalizacja wczytanego wektora = ");
	fprintf(out, "Normalizacja pierwszego wektora= ");
	normalizacja(w_1, norma_pierwsza, n1, out);
	printf("\n");
	fprintf(out,"\n");
        ...
        printf("Norma L2 wczytanego wektora = %f\n", L2(w_2, n2));
	printf("Norma pierwsza wczytanego wektora = %f\n", norma_pierwsza(w_2, n2));
	fprintf(out, "Normalizacja drugiego wektora= ");
	normalizacja(w_2, norma_pierwsza, n2, out);
	printf("\n");

        if (n1 == n2 ) {
                printf("Iloczyn skalarny wczytanych wektorow = %f\n", dot_product(w_1, w_2, n1));
		printf("Suma skalarna wczytanych wektorów = %f\n",dodawanie(w_1, w_2, n1));
        } else {
